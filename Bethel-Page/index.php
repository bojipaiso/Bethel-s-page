<?php
// index.php - COMPLETE VERSION with all your original CSS
...
<body>
    <header>
        <div class="container header-container">
            <div class="logo">
                <div class="logo-icon">
                    <div class="eagle-icon"><img src="https://tse2.mm.bing.net/th/id/OIP.1dKCNjbERJfKVTaBbG5tdAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3" alt="Bethel Logo" width="80" height="80"></div>
                </div>
                <div class="logo-text">
    ...
    <section class="hero">
        <div class="container">
            ...
            <a href="<?php echo htmlspecialchars($hero['cta_link'] ?? '#'); ?>" class="cta-button"><?php echo htmlspecialchars($hero['cta_text'] ?? 'Explore Our Programs'); ?></a>
        </div>
    </section>
    ...
    <main class="container">
            ...
            <?php if(count($features) > 0): ?>
                ...
                <div class="feature-card eagle-feature">
                    ...
                    <div class="feature-content">
                        <h3><span class="eagle-theme"><?php echo htmlspecialchars($feature['title']); ?></span></h3>
        ...
        <!-- Announcements Section - DYNAMIC CONTENT -->
        ...
        <div class="announcements">
            <?php if(count($announcements) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <!-- Default announcements if database is empty -->
                <div class="announcement-item">
                    <div class="announcement-date">
